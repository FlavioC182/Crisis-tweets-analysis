...
if __name__ == '__main__':
    myDatasetInput = pd.read_csv(
        'https://raw.githubusercontent.com/FlavioC182/Crisis-tweets-analysis/master/CrisisLexT26/2013_Colorado_floods/2013_Colorado_floods-tweets_labeled.csv', header=0)
    endDataset = metaDataExtraction(myDatasetInput)
    col_names = list(endDataset.columns.values)
    endDataset.to_csv(r'MetaDataFinal/2013_colorado_floods_metadati.csv',
